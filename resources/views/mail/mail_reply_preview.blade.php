...
@section('content')
    <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <h2 class="page-header">Preview Your Reply</h2>
                @include('extra.alert')
                <div class="panel panel-default">
                  ...
                  <div class="panel-footer">
                      <div class="row">
                          <div class="col-md-6">
                              <a href="{{ route('mail.reply.build', ['mail_id' => $header->mail_id]) }}" class="btn btn-warning btn-block">Edit This Message</a>
                          </div>
                          <div class="col-md-6">
                              {{ csrf_field() }}
                              <a href="{{ route('mail.reply.send', ['mail_id' => $header->mail_id]) }}" class="btn btn-success btn-block">Send Message</a>
                          </div>
                      </div>
                  </div>
