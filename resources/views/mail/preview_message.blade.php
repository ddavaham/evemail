                ...
                <div class="panel panel-default">
                    <form action="{{ route('mail.new', ['step_id' => 2]) }}" method="post">
                        ...
                        <div class="panel-footer">
                            <div class="row">
                                <div class="col-md-6">
                                    <a href="{{ route('mail.new', ['label_id' => 1]) }}" class="btn btn-warning btn-block">Edit This Message</a>
                                </div>
                                <div class="col-md-6">
                                    {{ csrf_field() }}
                                    <a href="{{ route('mail.new', ['label_id' => 3]) }}" class="btn btn-success btn-block">Send Message</a>
                                </div>
                            </div>
                        </div>
                    </form>
