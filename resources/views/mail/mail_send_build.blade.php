        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <div class="panel panel-default">
                    <form action="{{ route('mail.send.build.post') }}" method="post">
                                    ...
                                    @if (Session::has('recipients'))
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="{{ route('mail.send.build', ['remove' => $k]) }}">Remove This Recipient</a></li>
                                            </ul>
                                        </div>
                                        @endforeach
                                    @endif
...
<script>
    function addressBook() {
        var openAddressBook = window.open("{{ route('mail.send.recipient') }}", "Address Book", "height="+ (screen.height * .5) +" ,width="+ (screen.width * .5 )+",top="+ (screen.height * .25) +",left="+ (screen.width * .25));
    }
</script>
