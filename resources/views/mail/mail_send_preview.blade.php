            ...
            <div class="col-lg-9">
                ...
                <div class="panel panel-default">
                  ...
                  <div class="panel-footer">
                      <div class="row">
                          <div class="col-md-6">
                              <a href="{{ route('mail.send.build') }}" class="btn btn-warning btn-block">Edit This Message</a>
                          </div>
                          <div class="col-md-6">
                              {{ csrf_field() }}
                              <a href="{{ route('mail.send.send') }}" class="btn btn-success btn-block">Send Message</a>
                          </div>
                      </div>
                  </div>
